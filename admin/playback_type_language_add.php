...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  	<form class="form-horizontal" method="post" action="playback_type_language_post.php?id=000000" enctype='multipart/form-data'>
		...
		function back_page()
		{
			window.location.href = "playback_type_add.php";
		}
        </script>
    </body>
