...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  	<form class="form-horizontal" method="post" action="live_preview_language_post.php?id=<?php echo $id ?>&page=<?php echo $page ?>" enctype='multipart/form-data'>
		...
		function back_page()
		{
			window.location.href = "live_preview_edit.php?key=<?php echo $id ?>&page=<?php echo $_GET["page"] ?>";
		}
        </script>
    </body>
