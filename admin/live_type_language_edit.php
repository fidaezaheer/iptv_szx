...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  	<form class="form-horizontal" method="post" action="live_type_language_post.php?id=<?php echo $id ?>" enctype='multipart/form-data'>
		...
		function back_page()
		{
			window.location.href = "live_type_edit.php?id=<?php echo $id ?>";
		}
        </script>
    </body>
