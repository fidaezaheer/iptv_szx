                   ...
                   <!-- block -->
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><?php echo $lang_array["live_preview_add_text1"] ?></div>
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-mini focused" id="live_id" name="live_id" type="text" value="">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-medium focused" id="name" name="name" type="text" value="">&nbsp;&nbsp;
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input class="input-file uniform_on" id="file" name="file" type="file">&nbsp;&nbsp;<?php echo $lang_array["live_preview_add_text40"] ?>&nbsp;&nbsp;<input class="input-xxlarge focused" id="imageurl" name="imageurl" type="text" value="http://">
...
<?php
									...
									foreach($namess as $names) 
									{
										...
										echo "<input class='uniform_on' name='type_checkbox' style='width:15px;height:25px;' type='checkbox' value='" . $names[1] . "' />" . $names[0] . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
										if($index%5==0)
											echo "<br/>";
										$index++;
									}		
?>
  									...
  									<div class="control-group">
  										...
  										<div class="controls">
  											<select class="input-medium " name="sourcetype" id="sourcetype">
        										<option value="sd"><?php echo $lang_array["live_preview_add_text11"] ?></option>
        										<option value="hd" selected><?php echo $lang_array["live_preview_add_text12"] ?></option>
        										<option value="p"><?php echo $lang_array["live_preview_add_text13"] ?></option>
  											</select>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<?php echo $lang_array["live_preview_add_text30"] ?><input name="radio_watermark" type="radio" id="radio_watermark0" value="0" style="width:15px;height:28px;" checked >&nbsp;&nbsp;&nbsp;&nbsp;
                                          	<?php echo $lang_array["live_preview_add_text31"] ?><input name="radio_watermark" type="radio" id="radio_watermark1" value="1" style="width:15px;height:28px;" >
  									...
  									<div class="control-group">
  										...
  										<div class="controls">
                                            ...
                                            <input class="input-xxlarge focused" id="preview" name="preview" type="text" value="">
  										</div>
  									</div>                                                                                                         
                                    ...
                                    <input name="isinsert" id="isinsert" type="hidden" value=""/>
									</form>
                                </div>
                            </div>
                         </div>
        ...
        <script src="vendors/jquery-1.9.1.mini.js"></script>
...
function save()
{
	...
	document.authform.isinsert.value = 0;
	
	for(ii=0; ii<arrayId.length; ii++)
	{
		if(arrayId[ii].localeCompare(id) == 0)
		{
			var r=confirm("<?php echo $lang_array["live_preview_add_text39"] ?>");
			if(r==true)
  			{
				document.authform.isinsert.value = 1;
			}
			else
			{
...
{
	window.location.href = "playback_language_add.php";	
}
</script>
