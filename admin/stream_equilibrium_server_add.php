...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" method="post" action="stream_equilibrium_server_post.php" enctype='multipart/form-data'>
                                    	<fieldset><br/>
		...
		function back_page()
		{
			window.location.href = "stream_equilibrium_server_list.php";
