...
function tvolleh_preview($id,$previewurl)
{
...
function update_preview($preview_new,$id,$date)
{
	...
	$previewdate = str_replace("-","",$date);

	$previewurl = $previewid . "&nowdate=" . trim($previewdate) . "&time=00:00:00";
	$previewurl = str_replace(" ","",$previewurl);
	
	echo $previewurl . "<br/>";
	
	$previews = tvolleh_preview($urlid,$previewurl);
