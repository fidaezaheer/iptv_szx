                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<form class="form-horizontal" method="post" action="batch_playback_introduction_upload.php" enctype='multipart/form-data'>
...
?>                
		...
		<FORM name="authform_type" action="batch_playback_introduction_list.php" method="post">  
		...
		{
			echo "<form name='authform' method='post' action='batch_playback_introduction_post.php' enctype='multipart/form-data' >";
		}
		?>
