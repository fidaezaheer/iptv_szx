...
<html class="no-js">
    ...
    <body  onLoad="init()">
            ...
            <div class="row-fluid">
       	    	<table width="100%" border="0" align="center" height="1080">
  					<tr>
                        ...
                        <li class="active">
                            <a href="#"><?php echo $lang_array["left_4_text1"] ?></a>
                        </li>
                        <li>
                            <a href="playlist_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left_4_text2"] ?></a>
                        </li>
                        <li>
                            <a href="proxy_playlist_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left_4_text3"] ?></a>
                        </li>
                        <li>
                            <a href="custom_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left_4_text4"] ?></a>
                        </li>
                        <li>
                            <a href="account_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left_4_text5"] ?></a>
                        </li>
						</ul>
                        </td>
    					<td width="88%" align="center" valign="top" >
                        <iframe src="custom_list.php" width="100%" height="1080" frameBorder="0" name='mainFrame' id='mainFrame' title='mainFrame' onLoad="iFrameHeight()"></iframe>
                        </td>
  					</tr>
				</table>
          </div>
		...
		function init()
		{
			document.getElementById('mainFrame').src="custom_list.php";	
		}
        </script>
    </body>
