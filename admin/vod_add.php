						...
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" name="authform" method="post" action="vod_post.php?type=<?php echo $_GET["type"] ?>" enctype='multipart/form-data'>
                                    <fieldset><br/>

                                    <div class="control-group">
                                       <label class="control-label" for="focusedInput"><?php echo $lang_array["vod_add_text2"] ?></label>
                                       <div class="controls">
                                          <input class="input-large focused" id="name" name="name" type="text" value="">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input class="input-file uniform_on" id="file" name="file" type="file">&nbsp;&nbsp;<?php echo $lang_array["vod_add_text38"] ?>&nbsp;&nbsp;<input class="input-xlarge focused" id="iconurl" name="iconurl" type="text" value="http://">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="control-group">
  										...
  										<div class="controls">
										<?php echo $lang_array["vod_add_text17"] ?><input name="recommend" type="radio" id="recommend0" value="1" style="width:15px;height:28px;" >&nbsp;&nbsp;
                                        <?php echo $lang_array["vod_add_text18"] ?><input name="recommend" type="radio" id="recommend1" value="2" style="width:15px;height:28px;" >&nbsp;&nbsp;
                                        <?php echo $lang_array["vod_add_text19"] ?><input name="recommend" type="radio" id="recommend2" value="3" style="width:15px;height:28px;" >&nbsp;&nbsp;
  										<?php echo $lang_array["vod_add_text20"] ?><input name="recommend" type="radio" id="recommend3" value="4" style="width:15px;height:28px;" checked>&nbsp;&nbsp;
                                        <?php echo $lang_array["vod_add_text21"] ?><input name="recommend" type="radio" id="low_ps_radio0" value="5" style="width:15px;height:28px;" >
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input class="input-large focused" id="firstletter" name="firstletter" type="text" value="">
                                        </div>
                                    </div>          
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input class="input-large focused" id="introduction2" name="introduction2" type="text" value="">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <input class="input-xxlarge focused" id="introduction3" name="introduction3" type="text" value="">
                                        </div>
                                    </div>   
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <textarea class="input-xlarge focused" id="introduction4" name="introduction4" style="width: 810px; height: 80px"></textarea>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="control-group">
  										...
  										<div class="controls">
											<?php echo $lang_array["vod_add_text40"] ?><input type="radio" name="vodstatus" value="0" style="width:15px;height:28px;"  checked/>&nbsp;&nbsp;
                                            <?php echo $lang_array["vod_add_text41"] ?><input type="radio" name="vodstatus" value="1" style="width:15px;height:28px;"  />
                                        </div>
  									</div> 
                                    ...
                                    <div class="control-group">
										<label class="control-label" ><?php echo $lang_array["vod_add_text13"] ?></label>
                                       	...
                                       	<div class="controls">
											<input class="input-mini focused" id="num_id" name="num_id" type="text" value="" style="width:32px">&nbsp;<?php echo $lang_array["vod_add_text25"] ?>&nbsp;&nbsp;&nbsp;
...
function add()
{
	...
	else
	{
		...
		{
			//add_selected_one(items[ii].times,items[ii].value);
...
function save()
{
	...
	for(ii = 1; ii<rows; ii++)
	{
		...
		if(url.indexOf("p2p://") >= 0)
			option = option + num + "#" + url.replace("&amp;","&") + "geminipwgemini" + pw.replace("&amp;","&");
		else
			option = option + num + "#" + url.replace("&amp;","&");
