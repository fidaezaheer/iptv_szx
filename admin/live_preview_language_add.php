...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                  	<form class="form-horizontal" method="post" action="live_preview_language_post.php?id=20000" enctype='multipart/form-data'>
		...
		function back_page()
		{
			window.location.href = "live_preview_add.php";
		}
        </script>
    </body>
