						...
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" name="authform" method="post" action="proxy_children_post.php?proxy=<?php echo $name; ?>&level=<?php echo $level ?>" enctype='multipart/form-data'>
                                    <fieldset><br/>
