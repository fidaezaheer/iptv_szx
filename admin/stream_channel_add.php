	...
	*/
	...
	if(strstr($ret,"?xml") != false && strstr($ret,"version=") != false)
	{
		...
		foreach($channels as $channel){
			...
			array_push($channel_list_namess,$names);
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" name="authform" method="post" action="stream_channel_post.php" enctype='multipart/form-data'>
                                       ...
                                       <div class="controls">
                                          <input class="input-mini focused" id="urlid" name="urlid" type="text" value="<?php echo $add ?>" readonly>
                                       </div>
                                   	</div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-xlarge focused" id="tip" name="tip" type="text" value="">
                                       </div>
                                   	</div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-xlarge focused" id="name" name="name" type="text" value=""><label id="tipName" style="color:#F00"></label>
                                       </div>
                                   	</div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-xxlarge focused" id="url" name="url" type="text" value="">
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type='radio' name='pcache' id="pcache_id_0" value='0' style='width:15px;height:28px;'/>
                                          <?php echo $lang_array["stream_channel_add_text5"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='pcache' id="pcache_id_1" value='1' style='width:15px;height:28px;'/>
                                          <?php echo $lang_array["stream_channel_add_text6"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='pcache' id="pcache_id_2" value='2' style='width:15px;height:28px;'/>
                                          <?php echo $lang_array["stream_channel_add_text7"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='pcache' id="pcache_id_3" value='3' style='width:15px;height:28px;'/>
                                          <?php echo $lang_array["stream_channel_add_text8"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='pcache' id="pcache_id_4" value='4' style='width:15px;height:28px;'/>
                                          <?php echo $lang_array["stream_channel_add_text9"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='pcache' id="pcache_id_5" value='5' checked='checked' style='width:15px;height:28px;'/>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-mini focused" id="time" name="time" type="text" value="250">&nbsp;&nbsp;&nbsp;<?php echo $lang_array["stream_channel_add_text18"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <input type='radio' name='rtime' value='604800' checked='checked' onclick="rtime_change(250)" style='width:15px;height:28px;'/>
