...
<?php
	...
	$url = $sql->query_data($mydb, $mytable, "id", $id, "url");
	$appkey = $sql->query_data($mydb, $mytable, "id", $id, "appkey");
?>
<html>
                   ...
                   <!-- block -->
						<div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">忘我编缉库</div>
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" method="post" action="cj_post.php" enctype='multipart/form-data'>
                                       ...
                                       <div class="controls">
                                          <input class="input-xxlarge focused" id="name" name="name" type="text" value="<?php echo $name ?>">(注意：必须填写)
                                       </div>
                                   	</div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-xxlarge focused" id="url" name="url" type="text" value="<?php echo $url ?>">(注意：必须填写)
                                       </div>
                                   	</div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input class="input-xxlarge focused" id="appkey" name="appkey" type="text" value="<?php echo $appkey ?>">
                                       </div>
                                   	</div>
