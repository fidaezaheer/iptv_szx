                   ...
                   <!-- block -->
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><?php echo $lang_array["playback_add_text1"] ?></div>
                            </div>
                            
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" name="authform" method="post" action="playback_post.php" enctype='multipart/form-data'>
                                    <fieldset><br/>
  									...
  									<div class="control-group">
  										...
  										<div class="controls">
  											<select class="input-medium " name="sourcetype" id="sourcetype">
        										...
        										<option value="hd"><?php echo $lang_array["live_preview_add_text12"] ?></option>
