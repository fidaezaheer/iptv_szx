...
<html>
    ...
    <body>
						...
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" name="authform" method="post" action="custom_batch_authorization_post.php" enctype='multipart/form-data'>
                                    <fieldset><br/>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
											<input name="proxy" type="radio" id="proxy0" value="admin" style="width:15px;height:28px;" checked><?php echo $lang_array["custom_edit_text10"] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input name="proxy" type="radio" id="proxy1" value="proxy" style="width:15px;height:28px;" ><?php echo $lang_array["custom_edit_text11"] ?>  
                                    ...
                                    <input name="proxyv" id="proxyv" type="hidden" value=""/>
		...
		function save()
		{
			...
			document.authform.macs.value = "<?php echo $_POST["selbox"] ?>";
