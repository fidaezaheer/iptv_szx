                                ...
                                <div class="span12">   
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                        <thead>
            								...
            								<th width="8%" style="vertical-align:middle; text-align:center;"><?php echo $lang_array["stream_channel_list_text3"] ?></th>
            								...
            								<th width="12%" style="vertical-align:middle; text-align:center;"><?php echo $lang_array["stream_channel_list_text7"] ?></th>
...
<?php
										...
										foreach($dirnamess as $dirnames) 
										{
											...
											*/
											...
											echo "</table>";
											echo "</td>";
											echo "<td style='word-wrap:break-word; align:center; vertical-align:middle; text-align:center;'>" . $serverip . "</td>";
											...
											if($dirnames[2] != "push")
												...
												echo "<td style='word-wrap:break-word; align:center; vertical-align:middle; text-align:center;'></td>";
											$pdir = "";
											/*
...
?>
			...
			if(confirm("<?php echo $lang_array["stream_channel_list_text14"] ?>： " + id + " ?") == true)
  			{
				<?php
				if(isset($_GET["serverip"]))
					echo "window.location.href = \"stream_channel_del.php?urlid=\" + id + \"&serverip=\" + serverip + \"&servercheck=1\";";
				else
					echo "window.location.href = \"stream_channel_del.php?urlid=\" + id + \"&serverip=\" + serverip;";
				?>
			}
		}
			...
			if(confirm("<?php echo $lang_array["stream_channel_list_text14"] ?>： " + dir + " ?") == true)
  			{
				<?php
				if(isset($_GET["serverip"]))
					echo "window.location.href = \"stream_dir_del.php?dir=\" + dir + \"&serverip=\" + serverip + \"&servercheck=1\";";
				else
					echo "window.location.href = \"stream_dir_del.php?dir=\" + dir + \"&serverip=\" + serverip;";
				?>
			}
		}
		...
		function find_context()
		{
			...
			window.location.href = "stream_channel_list.php?find=" + value;			
		}
