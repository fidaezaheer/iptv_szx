...
<html class="no-js">
    ...
    <body  onLoad="init()">
            ...
            <div class="row-fluid">
       	    	<table width="100%" border="0" align="center" height="1080">
  					<tr>
                        ...
                        <li class="active">
                            <a href="#"><?php echo $lang_array["left5_text1"] ?></a>
                        </li>
                        <li>
                            <a href="version.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left5_text2"] ?></a>
                        </li>
                        
                        <li>
                            <a href="start_set.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left5_text3"] ?></a>
                        </li>
                        
                        <li>
                            <a href="background_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left5_text4"] ?></a>
                        </li>
                        
                        <li>
                            <a href="wifiap_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left5_text5"] ?></a>
                        </li>
                        
                        <li>
                            <a href="remote_list.php" target=mainFrame><i class="icon-chevron-right"></i><?php echo $lang_array["left5_text6"] ?></a>
                        </li>
                        
						</ul>
                        </td>
    					<td width="88%" align="center" valign="top" >
                        <iframe src="version.php" width="100%" height="1080" frameBorder="0" name='mainFrame' id='mainFrame' title='mainFrame' onLoad="iFrameHeight()"></iframe>
                        </td>
  					</tr>
				</table>
          </div>
		...
		function init()
		{
			document.getElementById('mainFrame').src="version.php";	
		}
        </script>
    </body>
