...
<html>
    ...
    <body>
                   ...
                   <!-- block -->
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><?php echo $lang_array["live_type_add_text1"] ?></div>
                            </div>
                            
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" method="post" action="live_type_post.php" enctype='multipart/form-data'>
                                    <fieldset><br/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
											<?php echo $lang_array["yes_text1"] ?><input name="need" type="radio" id="need0" value="1" style="width:15px;height:28px;" >&nbsp;&nbsp;
                                            <?php echo $lang_array["no_text1"] ?><input name="need" type="radio" id="need1" value="0" style="width:15px;height:28px;" checked >
                                        </div>    
                                    </div>
		...
		{
			window.location.href = "live_type_language_add.php";	
		}
