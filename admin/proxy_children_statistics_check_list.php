...
?>                                       
		...
		function back_page()
		{
			window.location.href = "proxy_children_statistics.php?starttime="+"<?php echo $starttime ?>"+"&endtime="+"<?php echo $endtime ?>"+"&proxy="+"<?php echo $_GET["proxy"]?>"+"&level=<?php echo $level ?>";
		}
