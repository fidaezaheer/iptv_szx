...
<html>
    ...
    <body>
						...
						<div class="block">
                          <div class="navbar navbar-inner block-header">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" method="post" action="playback_type_post.php?id=<?php echo $id ?>" enctype='multipart/form-data'>
                                    <fieldset><br/>
		...
		{
			window.location.href = "playback_type_language_edit.php?id=<?php echo $id ?>";	
