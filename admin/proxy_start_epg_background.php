                   ...
                   <!-- block -->
						<div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	<form class="form-horizontal" method="post" action="proxy_start_epg_edit_post.php" enctype='multipart/form-data'>
                                    	<fieldset><br/>
                                       ...
                                       <div class="controls">
    										...
    										<?php
												if($background == null || strlen($background) < 3)
												{
...
?>                                       
		...
		{
			window.location.href = "proxy_start_epg_edit_del.php?del=" + name;
		}
		
		function recovery()
		{
			window.location.href = "proxy_start_epg_del.php";	
		}

		function back_page()
		{
			window.location.href = "proxy_start_set.php";	
		}
        </script>
    </body>
