                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
											<?php  echo $lang_array["yes_text1"] ?><input name="rmd5" type="radio" id="rmd50" value="2" style="width:15px;height:28px;" >&nbsp;&nbsp;
                                            <?php  echo $lang_array["no_text1"] ?><input name="rmd5" type="radio" id="rmd51" value="0" style="width:15px;height:28px;" checked >
                                        </div>    
                                    </div> 
