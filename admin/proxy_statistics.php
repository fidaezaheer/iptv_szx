			...
			
			{
				...
				foreach($day_names as $day_name)
				{
					if(strcmp($day_name,"-1") == 0)
						...
						$t = $t . "时长:" . $day_name . "天" . "   " . "数量：" . $time_names[$day_name] . "&nbsp;&nbsp;&nbsp;&nbsp;<a href='proxy_statistics_check_list.php?proxy=" . $_GET["proxy"] . "&day=" . $day_name . "&playlist=all&starttime=" . $starttime . "&endtime=" . $endtime . "'>查看</a><br/>";
			...
			
			{
				...
				foreach($day_names as $day_name)
				{
					if(strcmp($day_name,"-1") == 0)
						...
						$t = $t . "时长:" . $day_name . "天" . "   " . "数量：" . $time_names[$day_name] . "&nbsp;&nbsp;&nbsp;&nbsp;<a href='proxy_statistics_check_list.php?proxy=" . $_GET["proxy"] . "&day=" . $day_name . "&playlist=auto&starttime=" . $starttime . "&endtime=" . $endtime . "'>查看</a><br/>";
					$total = $total + intval($time_names[$day_name]);
				}
			...
			foreach($type_namess as $type_names)
			{
					...
					{					
						if(strcmp($day_name,"-1") == 0)
							...
							$t = $t . "时长:" . $day_name . "天" . "   " . "数量：" . $time_names[$day_name] . "&nbsp;&nbsp;&nbsp;&nbsp;<a href='proxy_statistics_check_list.php?proxy=" . $_GET["proxy"] . "&day=" . $day_name . "&playlist=" . $type_names[2] . "&starttime=" . $starttime . "&endtime=" . $endtime . "'>查看</a><br/>";
						$total = $total + intval($time_names[$day_name]);
					}
